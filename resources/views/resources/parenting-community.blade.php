<x-layouts.public title="Parenting Community">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-20 select-none bg-white">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 items-center gap-12 lg:gap-16">
            ...
            <div class="lg:col-span-7 flex flex-col items-center lg:items-start text-center lg:text-left order-2 lg:order-1">
                ...
                <div class="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-indigo-500/20 bg-indigo-50 text-indigo-600 text-xs font-bold tracking-wider uppercase mb-6 animate-pulse">
                    <span class="w-2 h-2 rounded-full bg-indigo-500 shadow-[0_0_8px_#6366f1]"></span>
                    A respectful, insight-driven space. No noise
                </div>

                <h1 class="text-4xl sm:text-5xl xl:text-6xl font-black leading-tight text-slate-900 tracking-tight max-w-2xl mb-4">
                    Parenting <span class="text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-violet-600">Community</span>
                </h1>

                <h2 class="text-xl sm:text-2xl font-bold text-slate-800 mb-4 flex items-center gap-2 justify-center lg:justify-start">
                    ✨ Parenting with Clarity & Confidence
                </h2>

                <p class="text-base sm:text-lg text-slate-600 leading-relaxed max-w-xl font-medium mb-8">
                    Raising a child in today’s competitive world comes with constant questions and silent pressures. 
                    This <span class="font-semibold text-indigo-600">WhatsApp community</span> is designed to support parents with practical insights on student psychology, understanding your child, handling academic pressure, improving communication, navigating the teenage years, supporting better career decisions, and mindful parenting—shared with sensitivity and real experience. So you can guide your child with care and clarity, not uncertainty.
                </p>
                ...
                <div class="w-full max-w-xl mb-10 text-left bg-slate-50 p-6 rounded-2xl border border-slate-100 shadow-sm">
                    ...
                    <ul class="space-y-3.5">
                        <li class="flex items-start gap-3 text-slate-600 font-medium text-sm sm:text-base">
                            <span class="flex-shrink-0 text-emerald-500 text-lg mt-0.5">✔</span>
                            <span>Practical parenting strategies</span>
                        </li>
                        <li class="flex items-start gap-3 text-slate-600 font-medium text-sm sm:text-base">
                            <span class="flex-shrink-0 text-emerald-500 text-lg mt-0.5">✔</span>
                            <span>Understanding your child’s behaviour & mindset</span>
                        </li>
                        <li class="flex items-start gap-3 text-slate-600 font-medium text-sm sm:text-base">
                            <span class="flex-shrink-0 text-emerald-500 text-lg mt-0.5">✔</span>
                            <span>Guidance on academic pressure and career choices</span>
                        </li>
                        <li class="flex items-start gap-3 text-slate-600 font-medium text-sm sm:text-base">
                            <span class="flex-shrink-0 text-emerald-500 text-lg mt-0.5">✔</span>
                            <span>Real insights from counselling experience</span>
                        </li>
                    </ul>
                </div>

                <div class="w-full sm:w-auto">
                    <a href="YOUR_PARENT_WHATSAPP_GROUP_LINK" 
                       target="_blank"
            ...
            <div class="lg:col-span-5 order-1 lg:order-2 flex justify-center">
                <div class="relative w-full max-w-[480px] px-4 sm:px-0">
                    ...
                    <div class="absolute inset-0 bg-indigo-100 rounded-full blur-3xl opacity-40 pointer-events-none scale-75 animate-pulse"></div>
                    
                    <div class="relative transition-all duration-500 hover:scale-[1.03]">
                        <img src="{{ asset('/assets/images/services/img16.png') }}" 
                             alt="Parenting Community WhatsApp Network" 
